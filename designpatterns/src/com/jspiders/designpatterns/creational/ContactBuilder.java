...
public class ContactBuilder {
	...
	public ContactBuilder setMobileNumber(long mobileNumber) {
	...
	public Contact buildContact() {
		return new Contact(id, firstName, middleName, lastName, dob, gender, mobileNumber, work, landLine, email, website, address);
	}
